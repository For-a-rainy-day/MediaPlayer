...
import com.muhammadziyo.mediaplayer.Adapter.RvAdapter
import com.muhammadziyo.mediaplayer.Adapter.RvItemClick
import com.muhammadziyo.mediaplayer.Models.Music
 ...
 * Use the [FragmentMusic.newInstance] factory method to
        ...
        askPermission(Manifest.permission.READ_EXTERNAL_STORAGE) {
            ...
            val adapter = RvAdapter(musicList, object : RvItemClick{
                override fun itemClick(music: Music, position: Int) {
                    findNavController().navigate(R.id.fragmentMenu, bundleOf("music" to music, "position" to position))
                }
            })
